...
int modeArray[] = {1, 7}; //adjust this array to modify sequence of modes - as written, change to {0, 1, 2, 3, 4, 5} to access all modes
...
void kdenLive(){
  if (increment == 1) {
        ...
        topPixelsClear();
        pixels.setPixelColor(LEDCircle[LEDLight], pixels.Color(0, 255, 0));
        pixels.show(); // Show results
        increment = 0;
        decrement = 0;
        //delay(50);
